...
ax.set_title('Density Reconstruction $\\rho (x,t)$, [L-BFGS-B, Parabolic]', fontsize=10)
...
plt.savefig('../res_bund/ring_bfgs_bund_para_{}_{:.4f}.pdf'.format(N_u, error_u))
plt.savefig('../res_bund/ring_bfgs_bund_para_{}_{:.4f}.eps'.format(N_u, error_u))
plt.show()